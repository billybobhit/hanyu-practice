...
const FRENCH_GRADE_DATA: Record<GradeKey, GradeRevealEntry> = {
  ...
  B: {
    ...
    rayColor: "rgba(59,130,246,0.16)",
    bg: "radial-gradient(ellipse at center, rgba(14,45,115,0.48) 0%, #000 70%)",
    imgClass: "img-glow-b",
  },
  C: {
    imageUrl: makeUrl(
    ...
    rayColor: "rgba(125,211,252,0.09)",
    bg: "radial-gradient(ellipse at center, rgba(30,65,85,0.38) 0%, #000 70%)",
    imgClass: "img-glow-c",
  },
  D: {
    imageUrl: makeUrl(
...
const SPANISH_GRADE_DATA: Record<GradeKey, GradeRevealEntry> = {
  A: {
    ...
    rayColor: "rgba(52,211,153,0.16)",
    bg: "radial-gradient(ellipse at center, rgba(10,80,55,0.48) 0%, #000 70%)",
    imgClass: "img-glow-a",
  },
  B: {
    imageUrl: makeUrl(
    ...
    color: "#f43f5e",
    glow: "rgba(244,63,94,0.66)",
    rayColor: "rgba(244,63,94,0.14)",
    bg: "radial-gradient(ellipse at center, rgba(92,12,32,0.48) 0%, #000 70%)",
    imgClass: "img-glow-b",
  },
  C: {
    imageUrl: makeUrl(
    ...
    color: "#a8a29e",
    glow: "rgba(168,162,158,0.56)",
    rayColor: "rgba(168,162,158,0.1)",
    bg: "radial-gradient(ellipse at center, rgba(72,50,50,0.42) 0%, #000 70%)",
    imgClass: "img-glow-c",
  },
  D: {
    imageUrl: makeUrl(
